...
<!-- START HOME -->
<section id="home" class="home_bg" style="background-image: url({{ asset('/storage/landing/assets/img/bg/home-bg.jpg')}});  background-size:cover; background-position: center center;">
    <div class="container">
        <div class="row">
...
<!-- START TESTIMONIAL -->
<section data-stellar-background-ratio="0.3" class="our_testimonial section-padding" style="background-image: url({{ asset('/storage/landing/assets/img/bg/testimonial-bg.jpg')}});  background-size:cover;background-position:center;">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
                <div class="single_blog">
                    <div class="blog_img">
                        <a href="blog.html"><img src="{{ asset('/storage/landing/assets/img/blog/blog-1.jpg')}}" class="img-fluid" alt="image" /></a>
                        <div class="post-date">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12">
                <div class="single_blog">
                    <div class="blog_img">
                        <a href="blog.html"><img src="{{ asset('/storage/landing/assets/img/blog/blog-2.jpg')}}" class="img-fluid" alt="image" /></a>
                        <div class="post-date">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12">
                <div class="single_blog">
                    <div class="blog_img">
                        <a href="blog.html"><img src="{{ asset('/storage/landing/assets/img/blog/blog-3.jpg')}}" class="img-fluid" alt="image" /></a>
                        <div class="post-date">
